...
export default function OmkaramAgreementPage() {
  ...
  return (
    <div className="ag-page">
      ...
      <OmkaramDeed name={currentUser.name} email={currentUser.email} dateStr={dateStr} refNo={refNo} pan={me?.pan ?? currentUser.pan} aadhaar={me?.aadhaar ?? currentUser.aadhaar} address={me?.address ?? currentUser.address} guardian={me?.guardian ?? currentUser.guardian} execDate={omkHolding?.createdAt} />
    </div>
  );
}
